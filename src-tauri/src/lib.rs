...
use database_ops::{
    ...
    cleanup_expired_review_schedules_tx, cleanup_expired_trash_tx, cleanup_orphan_image_resources,
    ...
    save_note_review_schedule_tx, scan_orphan_image_resources, set_note_review_schedule_dirty_tx,
